...
public class BasicShip implements Ship {
    ...
    public BasicShip(String shipID, Player shipOwner, int x, int y, int z, int shipHullTotal, int shipShieldTotal, int shipHullDamagePerSecond, int shipShieldDamagePerSecond, double shipMovementSpeed, MainEngine mainCallBack) {
        this.shipID = shipID;
    ...
    @Override
    public void setStartJourneyTime() {
        Calendar cal = Calendar.getInstance();
        this.startJourneyTime = cal.getTime().getTime();
    }

    @Override
    public void removeShipFromSector() {
    ...
    public void addShipToSector(XYZcoord coord) {
    ...
    @Override
    public void setEndOfJourneyTime() {
        Calendar cal = Calendar.getInstance();
        this.endOfJourneyTime = cal.getTimeInMillis();
    }

    @Override
    public int numberOfSecondsTravelled() {
